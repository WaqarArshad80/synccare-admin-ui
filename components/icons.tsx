// Lucide icon paths as small React components (the DS uses Lucide throughout).
// Each takes standard SVG props so size/color inherit from CSS.
...
export const FacilityIcon = (p: IconProps) => (
  <Icon {...p}>
    <path d="M12 6v4" />
    <path d="M14 14h-4" />
    <path d="M14 18h-4" />
